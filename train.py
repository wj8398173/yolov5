...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=r"E:\yolov5\weights\yolov5s.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default=r"E:\yolov5\models\yolov5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=r'E:\yolov5\data\wjvoc.yaml', help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default=r'E:\yolov5\data\hyps\hyp.scratch-low.yaml', help="hyperparameters path")
